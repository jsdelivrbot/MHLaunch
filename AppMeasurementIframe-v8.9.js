...
var channel = pagenameobj.split(":")[0] + ":" + pagenameobj.split(":")[1] +  "-" + pagenameobj.split(":")[2];
...
if (/venue/g.test(pageURL) && /artist/g.test(pageURL) || /artist/g.test(pageURL)) {
    s.pageName = pagenameobj.replace("ccp-", "");
    s.campaign = newcString;
    s.channel = channel.replace("ccp-","");
    s.server = document.referrer.split("/")[2].toLowerCase();
    s.pageURL = pageURL;
    s.prop1 = typeof channel != "undefined" ? channel : "";
    s.eVar2 = "D=g";
    s.prop2 = "D=v2";
