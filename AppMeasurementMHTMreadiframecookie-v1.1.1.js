...
//  10.22.18 - Attempt to write the MID by catching the cookie value before it's set

/* SiteCatalyst code version: H.27.5. 'Just to add metrics'
Copyright 1996-2015 Adobe, Inc. All Rights Reserved
More info available at http://www.omniture.com */

console.log('Appmeasurement File Loaded - Heat Selected version 10.22.18');
...
a.g.length;c++)if(b=a.g[c],"prop"==b.substring(0,4)||"eVar"==b.substring(0,4)||"hier"==b.substring(0,4)||"list"==b.substring(0,4)||"channel"==b||"events"==b||"eventList"==b||"products"==b||"productList"==b||"purchaseID"==b||"transactionID"==b||"state"==b||"zip"==b||"campaign"==b)a[b]=void 0};a.tagContainerMarker="";a.cb=function(c,b){var d=a.Xa()+"/"+c+"?AQB=1&ndh=1&pf=1&"+(a.pa()?"callback=s_c_il["+a._in+"].doPostbacks&et=1&":"")+b+"&AQE=1";a.Wa(d);a.Ua(d);a.T()};a.Xa=function(){var c=a.Ya();return"https"+
...
//Call Visitor ID Service for Analytics
    s.visitor = s.marketingCloudVisitorID = getCookieValue("AMCV_1E701A795B111F550A495EAF%40AdobeOrg").split("%")[2];
...
if (parent.frames.document.location.host === "oss.ticketmaster.com" || parent.frames.document.location.host === "am.ticketmaster.com"){
    if (/cart\/review/.test(parent.frames.document.location.href) !== true && /buy\/browse/.test(parent.frames.document.location.href) !== true && /checkout\/confirmation/.test(parent.frames.document.location.href) !== true && /promotion/.test(parent.frames.document.location.href) !== true){
        try {
            //Get Global Ticketmaster Metrics    
            s.pageName = valPageName;
            s.channel = valch;
