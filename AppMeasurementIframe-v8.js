...
//  11.1.18 - Finalizing Season Ticket Code
...
var channel = setSections().basename + ":" + setSections().subSection;
//Parse Page Name Code
var parsep = channel + ":" + setSections().section + "-" + setSections().subSubSection;
} else {
var channel = setSections().basename + ":" + setSections().section;
var parsep = channel + ":" + setSections().subSection + "-" + setSections().subSubSection;
}
...
var eventName = cleanName(tm_data.eventn);
var eventID =  cleanName(tm_data.eventid);
...
if (/event/g.test(ihost)) {
    ...
    s.server = document.referrer.split("/")[2].toLowerCase();
    s.pageURL = pageURL;
    s.products = ";" + "tm" + "_" + eventID + "_" + eventName + "-" + eventDate +  ";" + ";" + ";" + ";";
