...
if (email === "" || getQueryParams(qstring).deliveryname === undefined) {
    ...
    console.log( "email" + ":" + email + ":" + "adobecampaign" );
}
...
if (/venueartist/g.test(ihost)) {
    ...
    s.eVar30 = typeof getQueryParams(qstring).eventid != "undefined" ? getQueryParams(qstring).eventid : ""; 	//TM Event Id
    s.eVar31 = typeof getQueryParams(qstring).eventn != "undefined" ? getQueryParams(qstring).eventn : ""; 	//TM Event Name
    s.eVar32 = typeof getQueryParams(qstring).venue != "undefined" ? getQueryParams(qstring).venue : ""; 	//TM Venue Name
    s.eVar33 = typeof getQueryParams(qstring).eventd != "undefined" ? getQueryParams(qstring).eventd : ""; 	//TM Event Date
    s.eVar34 = typeof getQueryParams(qstring).eventt != "undefined" ? getQueryParams(qstring).eventt : ""; 	//TM Event Time
    s.eVar35 = typeof getQueryParams(qstring).artistn != "undefined" ? getQueryParams(qstring).artistn : ""; 	//TM Artist Name
    s.eVar36 = typeof getQueryParams(qstring).artistid != "undefined" ? getQueryParams(qstring).artistid : ""; 	//TM Artist ID
    s.eVar37 = typeof getQueryParams(qstring).tktqty != "undefined" ? getQueryParams(qstring).tktqty : ""; 	//TM Tickets Purchased (Quantity)
    s.eVar38 = typeof getQueryParams(qstring).faceval != "undefined" ? getQueryParams(qstring).faceval : ""; 	//TM Face Value (Revenue without Fees)
    s.eVar39 = typeof getQueryParams(qstring).currency != "undefined" ? getQueryParams(qstring).currency : ""; 	//TM Currency
    s.eVar40 = typeof getQueryParams(qstring).order != "undefined" ? getQueryParams(qstring).order : ""; 	//TM Order
    s.eVar41 = typeof getQueryParams(qstring).confirmcode != "undefined" ? getQueryParams(qstring).confirmcode : ""; 	//TM Confirmation Code
    s.eVar42 = typeof getQueryParams(qstring).purchased != "undefined" ? getQueryParams(qstring).purchased : ""; 	//TM Purchase Date
    s.eVar43 = typeof getQueryParams(qstring).purchaset != "undefined" ? getQueryParams(qstring).purchaset : ""; 	//TM Purchase Time
    s.eVar44 = typeof getQueryParams(qstring).majorcat != "undefined" ? getQueryParams(qstring).majorcat : ""; 	//TM Major Category (Music, Sports)
    s.eVar45 = typeof getQueryParams(qstring).minorcat != "undefined" ? getQueryParams(qstring).minorcat : ""; //TM Minor Category (Rock, Baseball)
    s.eVar46 = parsep;
    s.eVar47 = typeof getQueryParams(qstring).inventory != "undefined" ? getQueryParams(qstring).inventory : ""; //TM Inventory Type (Primary, Resale)
