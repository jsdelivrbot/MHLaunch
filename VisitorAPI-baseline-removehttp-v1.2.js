    ...
    (function (i) {
        ...
        t.exports = function (e, t) {
            ...
            return {
                ...
                , url: null
                , getUrl: function () {
                    var t, i = window.document.location.protocol+"//fast."
                        , n = "?d_nsid=" + e.idSyncContainerID + "#" + encodeURIComponent(u.location.href);
                    return this.subdomain || (this.subdomain = "nosubdomainreturned"), e.loadSSL && (i = e.idSyncSSLUseAkamai ? window.document.location.protocol+"//fast." : "https://")
