...
if(/artist/g.test(setSections().subSection) && setSections().lastItem === "805966"){
    var partistid = "805966";
}
    
if (typeof getQueryParams(document.referrer.split("?")[1]).venueid !== "undefined"){
        var pvenueid = typeof getQueryParams(document.referrer.split("?")[1]).venueid != "undefined" ? getQueryParams(document.referrer.split("?")[1]).venueid : "";
    }   
...
//if artist ID is NOT in data layer
if (typeof artistID === "undefined" || artistID === ""){
        var artistID = partistid;
    }  else {
console.log("no value for artistID available");
    }
    
if (typeof venueID === "undefined" || venueID === ""){
        var venueID = pvenueid;
    }  else {
console.log("no value for venueID available");
    }

var venuepage = basename + "_" + venueID + "_" + artistID;
...
var channel = eventpage.split(":")[0] + ":" + eventpage.split(":")[1];
    ...
    s.eVar48 = typeof getQueryParams(qstring).camefrom != "undefined" ? getQueryParams(qstring).camefrom : "";
    s.t();
    console.log("season ticket purchase flow - buy detail page data");
}
...
var channel = pagenameobj.split(":")[0] + ":" + pagenameobj.split(":")[2];
    ...
    s.eVar48 = typeof getQueryParams(qstring).camefrom != "undefined" ? getQueryParams(qstring).camefrom : "";
    s.t();
    console.log("season ticket purchase flow - order confirmation page data");
}
...
var channel = pagenameobj.split(":")[0] + ":" + pagenameobj.split(":")[2];
    ...
    s.eVar48 = typeof getQueryParams(qstring).camefrom != "undefined" ? getQueryParams(qstring).camefrom : "";
    s.t();
    console.log("season ticket purchase flow - buy browse page data");
}
...
if (/amus:buy:cart/g.test(basename)){
    s.events = s.getValOnce("scView","cartview");
    //s.eVar1=s.getValOnce(variable,cookie,expiration,minute);
}

if (/amus:buy:review-&-submit/g.test(basename)){
    s.events = s.getValOnce("scCheckout","checkout");
}
    ...
    s.eVar48 = typeof getQueryParams(qstring).camefrom != "undefined" ? getQueryParams(qstring).camefrom : "";
    s.t();
    console.log("season ticket generic page data");
}
